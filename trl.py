...
def list_workspaces(workspace_dir):
    workspaces = [f for f in os.listdir(workspace_dir) if f.startswith('2024-03-27') and '020' in f and 'ch' in f]
...
def main_trl(args):
    ...
    for lm in ['scibert']:
        ...
        for ds in ['scicite_020']:
            aux_datasets = ['acl', 'kim', 'scicite_020']
